...
public class UserController {
        ...
        if (newStatus != null) {
            ...
            if (optionalUser.isPresent()) {
                ...
                try {
                    ...
                    // Sending email
                    String email = user.getEmail(); // Assuming user.getEmail() returns the email address
                    String companyName = user.getCompanyName(); // Assuming user.getCompanyName() returns the company name
    ...
    private void sendCongratulationsEmail(String email, String companyName) {
        ...
        String body = "<html>" +
                ...
                "<p><a href='https://dashboard.rubidelivery.com'>Login to Dashboard</a></p>" +
                "<p>If you still experience any problems, please contact our support at: <a href='mailto:support@rubidelivery.com'>support@rubidelivery.com</a></p>" +
    ...
    private void sendAccountDisabledEmail(String email) {
        ...
        String body = "<html>" +
                ...
                "<p><a href='mailto:support@rubidelivery.com'>support@rubidelivery.com</a></p>" +
                "</div>" +
                "</div>" +
                "</body>" +
                "</html>";
    ...
    private void sendEmail(String email, String subject, String body) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress("jmrubinusltd@gmail.com", "Rubi Logistics"));
    ...
    public ResponseEntity<Page<Rider>> getRiderAccounts(
        ...
        if (userOptional.isPresent()) {
            ...
            // Fetch the rider accounts created by the logged-in user with pagination
    ...
    public ResponseEntity<Rider> getRiderAccountById(@PathVariable Long id) {
        ...
        if (userOptional.isPresent()) {
            ...
            // Fetch the rider account by its ID and the user associated with it
            Optional<Rider> riderOptional = riderRepository.findByIdAndUser(id, user);

            // Check if the rider account exists and belongs to the user
    ...
    public ResponseEntity<RiderResponse> getRiderAccountsCount(
        ...
        if (userOptional.isPresent()) {
            ...
            // Fetch the rider accounts created by the specified user with pagination
            Page<Rider> riderAccounts = riderRepository.findByUser(user, pageable);

            // Count the total number of riders associated with the user
            long totalRiders = riderRepository.countByUser(user);

            // Create a RiderResponse object
